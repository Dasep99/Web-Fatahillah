            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('informasi.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                ...
                                <div class="col-sm-12">
                                    <table id="add-row" class="display table table-striped table-hover dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($informasi as $index => $row)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><img src="{{ asset('uploads/' . $row->gambar_informasi) }}"
                                                            width="50" alt=""></td>

                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('detail-informasi-admin', $row->id) }}"
                                                                class="btn btn-primary btn-sm mt-2 mr-2">Lihat</a>

                                                            <a id="delete" href="{{ route('informasi.edit', $row->id) }}"
