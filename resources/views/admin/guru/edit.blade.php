            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('adminguru.index') }}" class="btn btn-warning btn-sm ml-auto"><i
                                class=""></i> Back</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('adminguru.update', $guru->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" value="{{ $guru->nama }}" name="nama" required>
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset('uploads/' . $guru->gambar) }}" width="100" alt="">
                        </div>
