            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('adminguru.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                class=""></i> Tambah Data</a>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th style="width: 126.281px;" class="sorting" tabindex="0"
                                                    aria-controls="add-row" rowspan="1" colspan="1"
                                                    aria-label="Action: activate to sort column ascending">Nama Guru</th>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            ...
                                                            <a href="{{ route('adminguru.edit', $row->id) }}"
                                                                class="btn btn-warning btn-sm mt-2">Edit</a>
                                                            <form action="{{ route('adminguru.destroy', $row->id) }}"
                                                                method="POST"
                                                                class="
                                                            d-inline">
                                                                @csrf
