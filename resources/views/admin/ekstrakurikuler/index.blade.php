            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('ekstrakurikuleradmin.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                ...
                                <div class="col-sm-12">
                                    <table id="add-row" class="display table table-striped table-hover dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($ekstrakurikuler as $index => $row)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('detail-ekstrakurikuler-admin', $row->id) }}"
                                                                class="btn btn-primary btn-sm mt-2 mr-2">Lihat</a>

                                                            <a href="{{ route('ekstrakurikuleradmin.edit', $row->id) }}"
                                                                class="btn btn-warning btn-sm mt-2">Edit</a>
                                                            <form
                                                                action="{{ route('ekstrakurikuleradmin.destroy', $row->id) }}"
                                                                method="POST"
                                                                class="
                                                            d-inline">
                                                                @csrf
