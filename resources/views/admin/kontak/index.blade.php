            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('adminkontak.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th style="width: 126.281px;" class="sorting" tabindex="0"
                                                    aria-controls="add-row" rowspan="1" colspan="1"
                                                    aria-label="Action: activate to sort column ascending">Email</th>

                                                <th style="width: 126.281px;" class="sorting" tabindex="0"
                                                    aria-controls="add-row" rowspan="1" colspan="1"
                                                    aria-label="Action: activate to sort column ascending">Telepon</th>

                                                <th style="width: 126.281px;" class="sorting" tabindex="0"
                                                    aria-controls="add-row" rowspan="1" colspan="1"
                                                    aria-label="Action: activate to sort column ascending">Alamat</th>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($kontak as $index => $row)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $data = Str::of($row->alamat)->substr(0, 50) }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('detail-kontak-admin', $row->id) }}"
                                                                class="btn btn-primary btn-sm mt-2 mr-2">Lihat</a>

                                                            <a href="{{ route('adminkontak.edit', $row->id) }}"
                                                                class="btn btn-warning btn-sm mt-2">Edit</a>
                                                            <form action="{{ route('adminkontak.destroy', $row->id) }}"
                                                                method="POST"
                                                                class="
                                                            d-inline">
                                                                @csrf
