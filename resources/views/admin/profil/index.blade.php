        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Data Profil Pelajar</h2>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Data Profil Pelajar</h4>
                        <a href="{{ route('adminprofil.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('detail-profil-admin', $row->id) }}"
                                                                class="btn btn-primary btn-sm mt-2 mr-2">Lihat</a>

                                                            <a href="{{ route('adminprofil.edit', $row->id) }}"
                                                                class="btn btn-warning btn-sm mt-2">Edit</a>
                                                            <form action="{{ route('adminprofil.destroy', $row->id) }}"
                                                                method="POST"
                                                                class="
                                                            d-inline">
                                                                @csrf
