                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('file.update', $file->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $file->nama }}" name="nama" required>
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <br>
                            <label for="gambar">File Saat Ini</label> <br>
                            <img src="{{ asset('uploads/' . $file->file) }}" width="100" alt="">
                        </div>
