            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('prestasiadmin.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($prestasi as $index => $row)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><img src="{{ asset('uploads/' . $row->gambar_prestasi) }}"
                                                            width="50" alt=""></td>

                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('detail-prestasi-admin', $row->id) }}"
                                                                class="btn btn-primary btn-sm mt-2 mr-2">Lihat</a>

                                                            <a href="{{ route('prestasiadmin.edit', $row->id) }}"
                                                                class="btn btn-warning btn-sm mt-2">Edit</a>
                                                            <form action="{{ route('prestasiadmin.destroy', $row->id) }}"
                                                                method="POST"
                                                                class="
                                                            d-inline">
                                                                @csrf
