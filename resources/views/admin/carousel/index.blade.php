            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('carousel.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                ...
                                <div class="col-sm-12">
                                    <table id="add-row" class="display table table-striped table-hover dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($carousel as $index => $row)
                                                <tr role="row" class="odd">

                                                    <td>{{ $index + $carousel->firstItem() }}</td>
                                                    <td>{{ $row->judul }}</td>
