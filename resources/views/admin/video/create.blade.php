        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('adminvideo.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="gambar" placeholder="gambar"
                                name="gambar_video" required>
                        </div>
                        <div class="form-group">
                            <label>Video</label>
                            <input type="file" class="form-control" id="video" placeholder="video" name="video"
                                required>
                        </div>
                        <div class="form-group">
