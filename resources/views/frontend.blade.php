...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('assets/users/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('assets/users/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
